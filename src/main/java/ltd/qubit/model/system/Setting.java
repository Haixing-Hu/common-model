...
public class Setting implements Serializable, WithName, Creatable, Modifiable,
   ...
   */
  @Computed({"type", "value"})
  public Boolean getBool() throws TypeMismatchException {
    if (type != Type.BOOL) {
   ...
   */
  @Computed({"type", "value"})
  public Boolean[] getBools() throws TypeMismatchException {
    if (type != Type.BOOL) {
      throw new TypeMismatchException(Type.BOOL, type);
    }
    if ((parsedValue == null) && (value != null)) {
   ...
   */
  @Computed({"type", "value"})
  public Character getChar() throws TypeMismatchException {
    if (type != Type.CHAR) {
   ...
   */
  @Computed({"type", "value"})
  public Character[] getChars() throws TypeMismatchException {
    if (type != Type.CHAR) {
      throw new TypeMismatchException(Type.CHAR.name(), type.name());
    }
    if ((parsedValue == null) && (value != null)) {
   ...
   */
  @Computed({"type", "value"})
  public Byte[] getBytes() throws TypeMismatchException {
    if (type != Type.BYTE) {
      throw new TypeMismatchException(Type.BYTE.name(), type.name());
    }
    if ((parsedValue == null) && (value != null)) {
   ...
   */
  @Computed({"type", "value"})
  public Short[] getShorts() throws TypeMismatchException {
    if (type != Type.SHORT) {
      throw new TypeMismatchException(Type.SHORT.name(), type.name());
    }
    if ((parsedValue == null) && (value != null)) {
   ...
   */
  @Computed({"type", "value"})
  public Integer getInt() throws TypeMismatchException {
    if (type != Type.INT) {
   ...
   */
  @Computed({"type", "value"})
  public Integer[] getInts() throws TypeMismatchException {
    if (type != Type.INT) {
      throw new TypeMismatchException(Type.INT.name(), type.name());
    }
    if ((parsedValue == null) && (value != null)) {
   ...
   */
  @Computed({"type", "value"})
  public Long[] getLongs() throws TypeMismatchException {
    if (type != Type.LONG) {
      throw new TypeMismatchException(Type.LONG.name(), type.name());
    }
    if ((parsedValue == null) && (value != null)) {
   ...
   */
  @Computed({"type", "value"})
  public Float[] getFloats() throws TypeMismatchException {
    if (type != Type.FLOAT) {
      throw new TypeMismatchException(Type.FLOAT, type);
    }
    if ((parsedValue == null) && (value != null)) {
   ...
   */
  @Computed({"type", "value"})
  public Double[] getDoubles() throws TypeMismatchException {
    if (type != Type.DOUBLE) {
      throw new TypeMismatchException(Type.DOUBLE.name(), type.name());
    }
    if ((parsedValue == null) && (value != null)) {
   ...
   */
  @Computed({"type", "value"})
  public String[] getStrings() throws TypeMismatchException {
    if (type != Type.STRING) {
   ...
   */
  @Computed({"type", "value"})
  public LocalDate getDate() throws TypeMismatchException,
      NoSuchElementException {
    if (type != Type.DATE) {
   ...
   */
  @Computed({"type", "value"})
  public LocalDate[] getDates() throws TypeMismatchException {
    if (type != Type.DATE) {
      throw new TypeMismatchException(Type.DATE.name(), type.name());
    }
    if ((parsedValue == null) && (value != null)) {
   ...
   */
  @Computed({"type", "value"})
  public LocalTime getTime() throws TypeMismatchException,
      NoSuchElementException {
    if (type != Type.TIME) {
   ...
   */
  @Computed({"type", "value"})
  public LocalTime[] getTimes() throws TypeMismatchException {
    if (type != Type.TIME) {
      throw new TypeMismatchException(Type.TIME.name(), type.name());
    }
    if ((parsedValue == null) && (value != null)) {
   ...
   */
  @Computed({"type", "value"})
  public LocalDateTime getDateTime() throws TypeMismatchException,
      NoSuchElementException {
   ...
   */
  @Computed({"type", "value"})
  public LocalDateTime[] getDateTimes() throws TypeMismatchException {
    if (type != Type.DATETIME) {
      throw new TypeMismatchException(Type.DATETIME.name(), type.name());
    }
    if ((parsedValue == null) && (value != null)) {
   ...
   */
  @Computed({"type", "value"})
  public Timestamp[] getTimestamps() throws TypeMismatchException {
    if (type != Type.TIMESTAMP) {
      throw new TypeMismatchException(Type.TIMESTAMP.name(), type.name());
    }
    if ((parsedValue == null) && (value != null)) {
   ...
   */
  @Computed({"type", "value"})
  public BigInteger getBigInteger() throws TypeMismatchException,
      NoSuchElementException {
   ...
   */
  @Computed({"type", "value"})
  public BigInteger[] getBigIntegers() throws TypeMismatchException {
    if (type != Type.BIG_INTEGER) {
      throw new TypeMismatchException(Type.BIG_INTEGER.name(), type.name());
    }
    if ((parsedValue == null) && (value != null)) {
   ...
   */
  @Computed({"type", "value"})
  public BigDecimal[] getBigDecimals() throws TypeMismatchException {
    if (type != Type.BIG_DECIMAL) {
      throw new TypeMismatchException(Type.BIG_DECIMAL.name(), type.name());
    }
    if ((parsedValue == null) && (value != null)) {
   ...
   */
  @Computed({"type", "value"})
  public byte[] getByteArray() throws TypeMismatchException,
      NoSuchElementException {
   ...
   */
  @Computed({"type", "value"})
  public byte[][] getByteArrays() throws TypeMismatchException {
    if (type != Type.BYTE_ARRAY) {
      throw new TypeMismatchException(Type.BYTE_ARRAY.name(), type.name());
    }
    if ((parsedValue == null) && (value != null)) {
   ...
   */
  public final <E extends Enum<E>> Setting setEnum(@Nullable final E value) {
    setString(value == null ? null : value.name());
    return this;
  }
  ...
  public final <E extends Enum<E>> Setting setEnums(final E... values) {
    ...
    for (int i = 0; i < values.length; ++i) {
      names[i] = (values[i] == null ? null : values[i].name());
    }
    setStrings(names);
    return this;
  }
