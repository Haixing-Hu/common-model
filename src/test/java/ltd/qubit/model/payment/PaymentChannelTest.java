...
/**
 * Unit test of the {@link PaymentChannel} class.
 *
 * @author Haixing Hu
 */
public class PaymentChannelTest extends ModelTestBase<PaymentChannel> {

  public PaymentChannelTest() {
  ...
  public void testGetLocalizedName() {
    ...
    for (final PaymentChannel obj : PaymentChannel.values()) {
