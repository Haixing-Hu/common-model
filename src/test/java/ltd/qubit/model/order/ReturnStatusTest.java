...
/**
 * Unit test of the {@link ReturnStatus} class.
 *
 * @author Haixing Hu
 */
public class ReturnStatusTest extends ModelTestBase<ReturnStatus> {

  public ReturnStatusTest() {
    super(ReturnStatus.class);
  }
  ...
  public void testGetLocalizedName() {
    ...
    for (final ReturnStatus obj : ReturnStatus.values()) {
