...
/**
 * Unit test of the {@link ReturnIssuer} class.
 *
 * @author Haixing Hu
 */
public class ReturnIssuerTest extends ModelTestBase<ReturnIssuer> {

  public ReturnIssuerTest() {
    super(ReturnIssuer.class);
  }
  ...
  public void testGetLocalizedName() {
    ...
    for (final ReturnIssuer obj : ReturnIssuer.values()) {
