...
/**
 * Unit test of the {@link InvoiceTitleType} class.
 *
 * @author Haixing Hu
 */
public class InvoiceTitleTypeTest extends ModelTestBase<InvoiceTitleType> {

  public InvoiceTitleTypeTest() {
    super(InvoiceTitleType.class);
  }
  ...
  public void testGetLocalizedName() {
    ...
    for (final InvoiceTitleType obj : InvoiceTitleType.values()) {
