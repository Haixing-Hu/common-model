...
/**
 * Unit test of the {@link InvoiceStockStatus} class.
 *
 * @author Haixing Hu
 */
public class InvoiceStockStatusTest extends ModelTestBase<InvoiceStockStatus> {

  public InvoiceStockStatusTest() {
    super(InvoiceStockStatus.class);
  }
  ...
  public void testGetLocalizedName() {
    ...
    for (final InvoiceStockStatus obj : InvoiceStockStatus.values()) {
