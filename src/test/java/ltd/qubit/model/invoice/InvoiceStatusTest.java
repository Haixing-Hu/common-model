...
/**
 * Unit test of the {@link InvoiceStatus} class.
 *
 * @author Haixing Hu
 */
public class InvoiceStatusTest extends ModelTestBase<InvoiceStatus> {
  ...
  public void testGetLocalizedName() {
    ...
    for (final InvoiceStatus obj : InvoiceStatus.values()) {
