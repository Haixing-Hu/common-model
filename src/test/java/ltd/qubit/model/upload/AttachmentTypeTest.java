...
/**
 * Unit test of the {@link AttachmentType} class.
 *
 * @author Haixing Hu
 */
public class AttachmentTypeTest extends ModelTestBase<AttachmentType> {
  ...
  public void testGetLocalizedName() {
    ...
    for (final AttachmentType obj : AttachmentType.values()) {
