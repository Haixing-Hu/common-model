...
/**
 * Unit test of the {@link MedicalType} class.
 *
 * @author Haixing Hu
 */
public class MedicalTypeTest extends ModelTestBase<MedicalType> {

  public MedicalTypeTest() {
  ...
  public void testGetLocalizedName() {
    ...
    for (final MedicalType obj : MedicalType.values()) {
